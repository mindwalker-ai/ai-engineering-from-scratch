...
<p align="center">
  ...
  <a href="https://github.com/mindwalker-ai/ai-engineering-from-scratch/stargazers"><img src="https://img.shields.io/github/stars/mindwalker-ai/ai-engineering-from-scratch?style=flat-square&labelColor=fafaf5&color=3553ff" alt="GitHub stars"></a>
...
```bash
git clone https://github.com/mindwalker-ai/ai-engineering-from-scratch.git
...
```bash
npx skills add mindwalker-ai/ai-engineering-from-scratch                       # every skill
npx skills add mindwalker-ai/ai-engineering-from-scratch --skill agent-loop    # one skill
npx skills add mindwalker-ai/ai-engineering-from-scratch --phase 14            # one phase
```
...
Sign up via [GitHub Sponsors](https://github.com/sponsors/mindwalker-ai).
...
<a href="https://star-history.com/#mindwalker-ai/ai-engineering-from-scratch&Date">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=mindwalker-ai/ai-engineering-from-scratch&type=Date&theme=dark">
    <img alt="Star history" src="https://api.star-history.com/svg?repos=mindwalker-ai/ai-engineering-from-scratch&type=Date" width="100%">
  </picture>
</a>
...
Maintained by [Mindwalker.ai](https://github.com/mindwalker-ai) and the community.

<sub>
  <a href="https://x.com/ghumare64">@ghumare64</a> &nbsp;·&nbsp;
  <a href="https://aiengineeringfromscratch.com">aiengineeringfromscratch.com</a> &nbsp;·&nbsp;
  <a href="https://github.com/mindwalker-ai/ai-engineering-from-scratch/issues/new/choose">Report / Suggest</a>
</sub>
